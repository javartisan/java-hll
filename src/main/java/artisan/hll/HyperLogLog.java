...
/**
 * 学习示例代码,代码出处：https://www.jianshu.com/p/55defda6dcd2
 */
public class HyperLogLog {
    ...
    public static void main(String[] args) {
        HyperLogLog hyperLogLog = new HyperLogLog(0.001);//64个桶
        //集合中只有下面这些元素
        int size = 1000000;
        ...
        System.out.println(((hyperLogLog.cardinality() - size) * 100.0 / size) + "%");
    }
}
